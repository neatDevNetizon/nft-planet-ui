          ...
          >
            ...
            <Box width="100%" align="right">
              <IconButton 
                  ...
                  marginTop={{base:"20px", md:"2px", lg:"4px", xl:"6px", "2xl":"8px"}}
                  marginRight={{base:"0px", md:"2px", lg:"4px", xl:"6px", "2xl":"8px"}}
              />
            </Box> 
            <Box 
              width="100%" 
              height="20%"
              align="center"
              marginTop={{base:"-20px", md:"-10px", lg:"-20px", xl:"-30px", "2xl":"-40px"}}
            >
              <Center h="100%">
            ...
            <Box
              ...
              height="78%"
            >
              <Box w="100%" h="95%" overflow="hidden" position="relative">
